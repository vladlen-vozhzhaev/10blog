                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto py-4 py-lg-0">
                        ...
                        <? if(empty($_SESSION['id'])): ?>
                          <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/auth">Войти</a></li>
                          <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/reg">Регистрация</a></li>
                        <? else: ?>
                          <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="/user">Личный кабинет</a></li>
